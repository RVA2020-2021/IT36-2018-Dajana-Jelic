...
public class Swagger {
	...
	public static final Contact DEFAULT_CONTACT= new Contact("Dajana Jelic",
			"https://github.com/dajanaIT36-2018","dajana.jelic@uns.ac.rs");
	
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Backend RVA Swagger ",
			"Razvoj viseslojnih aplikacija", "1.0", "", DEFAULT_CONTACT, "", "",new ArrayList<VendorExtension>());
