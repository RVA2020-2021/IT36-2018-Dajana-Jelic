...
public class ProizvodjacRestController {
	...
	@ApiOperation(value="Vraca jednog proizvodjaca iz baze podataka")
	...
	@ApiOperation(value="Vraca proizvodjaca po nazivu iz baze podataka")
	...
	@ApiOperation(value="Izmenjuje proizvodjaca u bazi podataka")
	...
	public ResponseEntity<Proizvodjac> deleteProizvodjac(@PathVariable("id") Integer id) 
	{
        ...
        if(id == -100) 
        {
        	jdbcTemplate.execute(
        			"INSERT INTO \"proizvodjac\"(\"id\", \"adresa\", \"kontakt\", \"naziv\")"
        			+ "VALUES (-100, 'Test Adresa', '0606641163', 'naziv test')"
        	);
